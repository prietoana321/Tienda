...
<body class="bg-dark">
	<header>
		<img  class="logo" src="<?php echo(base_url('../Multimedia/logo_editado-1.png'))?>"  alt="">
		<div class="container">
            <div class="row">
                <div class="col-12">
		...
		<div class="row">
			<div class="col-4">
				<div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
					...
					<div class="card-body">
					  ...
					  <img src="img/WhatsApp Image 2020-07-20 at 18.03.52 (2).jpeg" width="200px" height="150px"  alt="">
					  <a class="navbar-brand text-white texxto" href="#">
			...
			<div class="col-4">
				<div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
					...
					<div class="card-body">
					  ...
					  <img src="img/WhatsApp Image 2020-07-20 at 17.45.20.jpeg" width="200px" height="150px"  alt="">
					  <a class="navbar-brand text-white texxto" href="#">
						<a class="nav-link  btn btn-outline-light my-2 my-sm-0" href="addproductes.html"><span class="icon-home3"></span>SEE MORE</a>
				      </a>
					</div>
			...
			<div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
				...
				<div class="card-body">
				  ...
				  <img src="img/WhatsApp Image 2020-07-20 at 18.03.51 (2).jpeg" width="200px" height="150px"  alt="">
					  <a class="navbar-brand text-white texxto" href="#">
						<a class="nav-link  btn btn-outline-light my-2 my-sm-0" href="addproductes.html"><span class="icon-home3"></span>SEE MORE</a>
				      </a>
				</div>
		...
		<div class="row">
			<div class="col-4">
				<div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
					...
					<div class="card-body">
					  <h5 class="card-title">Bathrooms and toilets</h5>
					  <img src="img/WhatsApp Image 2020-07-20 at 17.38.51 (3).jpeg" width="230px" height="150px"  alt="">
					  <a class="navbar-brand text-white texxto" href="#">
						<a class="nav-link  btn btn-outline-light my-2 my-sm-0" href="addproductes.html"><span class="icon-home3"></span>SEE MORE</a>
				      </a>
					</div>
			...
			<div class="col-4">
				<div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
					...
					<div class="card-body">
					  <h5 class="card-title">Bathrooms and toilets</h5>
					  <img src="img/WhatsApp Image 2020-07-20 at 17.38.24.jpeg" width="200px" height="150px"  alt="">
					  <a class="navbar-brand text-white texxto" href="#">
						<a class="nav-link  btn btn-outline-light my-2 my-sm-0" href="addproductes.html"><span class="icon-home3"></span>SEE MORE</a>
				      </a>
					</div>
			...
			<div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
				...
				<div class="card-body">
				  <h5 class="card-title">Bathrooms and toilets</h5>
				  <img src="img/WhatsApp Image 2020-07-20 at 17.38.24 (1).jpeg" width="200px" height="150px"  alt="">
					  <a class="navbar-brand text-white texxto" href="#">
						<a class="nav-link  btn btn-outline-light my-2 my-sm-0" href="addproductes.html"><span class="icon-home3"></span>SEE MORE</a>
				    </a>
				</div>
