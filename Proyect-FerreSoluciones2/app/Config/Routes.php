...
//-----------------------------------------------------------
//página de programadores------------------------------------
$routes->get('/clientes', 'Home::index');
//-----------------------------------------------------------
//página para agregar productos-------------------
$routes->get('/productos', 'AddContoller::index');
$routes->post('/productos/agregar', 'AddController::add');
//-------------------------------------------------
//página de registro--------------------------------
//---------------------------------------------------
//página principal-------------------------------------
$routes->get('/altaGama', 'HomePageController::index');
//-----------------------------------------------------
$routes->post('/productos/img', 'AddController::add');
